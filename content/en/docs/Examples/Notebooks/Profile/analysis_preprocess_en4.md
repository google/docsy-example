...
```
    ...
    /tmp/ipykernel_3772/3838477898.py in <cell line: 2>()
...
```
    ...
    /tmp/ipykernel_3772/2450699116.py in <cell line: 1>()
    ----> 1 profile = profile.subset_indices_lonlat_box(longitude_bounds, latitude_bounds)
    

    /usr/share/miniconda/envs/coast/lib/python3.8/site-packages/coast/data/profile.py in subset_indices_lonlat_box(self, lonbounds, latbounds)
        150         """
...
```
    ...
    /tmp/ipykernel_3772/567752478.py in <cell line: 1>()
...
```
    ...
    /tmp/ipykernel_3772/2338363098.py in <cell line: 1>()
    ----> 1 processed_profile = profile.process_en4()
    

    /usr/share/miniconda/envs/coast/lib/python3.8/site-packages/coast/data/profile.py in process_en4(self, sort_time)
...
```
    ...
    /tmp/ipykernel_3772/1086284925.py in <cell line: 1>()
