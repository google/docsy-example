...
```
    ...
    <matplotlib.collections.QuadMesh at 0x7fd674a2af10>
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7fd67492a5b0>
...
```
    ...
    <matplotlib.legend.Legend at 0x7fd674675fd0>
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7fd6743ec8e0>
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7fd675d53850>
