...
```
    ...
    <matplotlib.collections.QuadMesh at 0x7fdf58c52190>
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7fdf58b41e50>
...
```
    ...
    <matplotlib.legend.Legend at 0x7fdf58c6f610>
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7fdf5860a970>
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7fdf59f6fb80>
