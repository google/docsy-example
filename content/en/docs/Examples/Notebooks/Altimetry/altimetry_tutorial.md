...
```
    ...
    Altimetry object at 0x55fed38b3fc0 initialised
...
```
    ...
    Subsetting Altimetry object at 0x55fed38b3fc0 indices in [-10, 10], [45, 60]
...
```
    ...
    Interpolating Gridded object at 0x55fed38b3fc0 "ssh" with time_interp "nearest"
...
```
    ...
    /tmp/ipykernel_3910/1029636237.py in <cell line: 4>()
...
```
    ...
    /tmp/ipykernel_3910/3088798311.py in <cell line: 3>()
...
```
    ...
    /tmp/ipykernel_3910/4195741849.py in <cell line: 2>()
          1 # stats quick_plot:
