...
```
    ...
    Altimetry object at 0x5580a6adbfc0 initialised
...
```
    ...
    Subsetting Altimetry object at 0x5580a6adbfc0 indices in [-10, 10], [45, 60]
...
```
    ...
    Interpolating Gridded object at 0x5580a6adbfc0 "ssh" with time_interp "nearest"
