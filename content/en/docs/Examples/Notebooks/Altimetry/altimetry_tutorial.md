...
```
    ...
    Altimetry object at 0x56408157efc0 initialised
...
```
    ...
    Subsetting Altimetry object at 0x56408157efc0 indices in [-10, 10], [45, 60]
...
```
    ...
    Interpolating Gridded object at 0x56408157efc0 "ssh" with time_interp "nearest"
