...
```
    ...
    Altimetry object at 0x5635d3a81fc0 initialised
...
```
    ...
    Subsetting Altimetry object at 0x5635d3a81fc0 indices in [-10, 10], [45, 60]
...
```
    ...
    Interpolating Gridded object at 0x5635d3a81fc0 "ssh" with time_interp "nearest"
...
```
    ...
    /tmp/ipykernel_3656/1478867203.py in <cell line: 4>()
...
```
    ...
    /tmp/ipykernel_3656/3088798311.py in <cell line: 3>()
...
```
    ...
    /tmp/ipykernel_3656/4195741849.py in <cell line: 2>()
          1 # stats quick_plot:
