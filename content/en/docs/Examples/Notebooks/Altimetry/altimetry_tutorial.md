...
```
    ...
    Altimetry object at 0x5650c0a26fc0 initialised
...
```
    ...
    Subsetting Altimetry object at 0x5650c0a26fc0 indices in [-10, 10], [45, 60]
...
```
    ...
    Interpolating Gridded object at 0x5650c0a26fc0 "ssh" with time_interp "nearest"
