...
```
    ...
    Altimetry object at 0x557ae3732fc0 initialised
...
```
    ...
    Subsetting Altimetry object at 0x557ae3732fc0 indices in [-10, 10], [45, 60]
...
```
    ...
    Interpolating Gridded object at 0x557ae3732fc0 "ssh" with time_interp "nearest"
...
```
    ...
    /tmp/ipykernel_3647/1478867203.py in <cell line: 4>()
...
```
    ...
    /tmp/ipykernel_3647/3088798311.py in <cell line: 3>()
...
```
    ...
    /tmp/ipykernel_3647/4195741849.py in <cell line: 2>()
          1 # stats quick_plot:
