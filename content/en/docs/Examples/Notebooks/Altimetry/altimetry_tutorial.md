...
```
    ...
    Altimetry object at 0x55da58cccfc0 initialised
...
```
    ...
    Subsetting Altimetry object at 0x55da58cccfc0 indices in [-10, 10], [45, 60]
...
```
    ...
    Interpolating Gridded object at 0x55da58cccfc0 "ssh" with time_interp "nearest"
