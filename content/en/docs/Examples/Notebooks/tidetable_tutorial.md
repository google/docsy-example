...
```python
# You can alter these paths if you do not want to use the default data files.
dir = "./example_files/"
fn_dom = dir + "coast_example_nemo_domain.nc"
fn_dat = dir + "coast_example_nemo_data.nc"
fn_config = "./config/example_nemo_grid_t.json"
fn_tg = dir + "tg_amm15.nc"  # This should already be processed, on the same time dimension
```
